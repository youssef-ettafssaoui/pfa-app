...
class AppointmentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->back()->with('message', 'Rendez-vous créé pour' . $request->date);
    }
    ...
    public function check(Request $request)
    {
        ...
        if (!$appointment) {
            return redirect()->to('/appointment')->with('errmessage', 'Heure de rendez-vous non disponible pour cette date');
        }
    ...
    public function updateTime(Request $request)
    {
        ...
        return redirect()->route('appointment.index')->with('message', 'Heure de rendez-vous Mise à Jour !');
    }
}