...
<html class="no-js" lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('back/plugins/tempusdominus-bootstrap-4/build/css/tempusdominus-bootstrap-4.min.css') }}">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right notification-dropdown" aria-labelledby="notiDropdown">
                                    ...
                                    <div class="notifications-wrap">
                                        ...
                                        <a href="#" class="media">
                                            <span class="d-flex">
                                                <img src="{{ asset('back/img/users/1.jpg') }}" class="rounded-circle" alt="">
                                            </span>
                                            <span class="media-body">
                ...
                <div class="app-sidebar colored">
                    <div class="sidebar-header">
                        <a class="header-brand" href="index.html">
                            <div class="logo-img">
                               <img src="{{ asset('back/src/img/brand-white.svg') }}" class="header-brand-img" alt="lavalite"> 
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    ...
                                    <div class="card-body chat-box scrollable" style="height:300px;">
                                        <ul class="chat-list">
                                            <li class="chat-item">
                                                <div class="chat-img"><img src="{{ asset('back/img/users/1.jpg') }}" alt="user"></div>
                                            ...
                                            <li class="chat-item">
                                                <div class="chat-img"><img src="{{ asset('back/img/users/2.jpg') }}" alt="user"></div>
                                                <div class="chat-content">
                                            ...
                                            <li class="chat-item">
                                                <div class="chat-img"><img src="{{ asset('back/img/users/3.jpg') }}" alt="user"></div>
                                                <div class="chat-content">
                                ...
                                <table id="advanced_table" class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><img src="{{ asset('back/img/users/1.jpg') }}" class="table-user-thumb" alt=""></td>
                                            <td>Tiger Nixon</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="{{ asset('back/img/users/2.jpg') }}" class="table-user-thumb" alt=""></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="{{ asset('back/img/users/3.jpg') }}" class="table-user-thumb" alt=""></td>
                                            <td>Ashton Cox</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="{{ asset('back/img/users/4.jpg') }}" class="table-user-thumb" alt=""></td>
                                            <td>Cedric Kelly</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="{{ asset('back/img/users/5.jpg') }}" class="table-user-thumb" alt=""></td>
                                            <td>Airi Satou</td>
                                            <td>Accountant</td>
                                            <td>Tokyo</td>
                                            <td>33</td>
                        ...
                        <div class="chat-list">
                            <div class="list-group row">
                                ...
                                <a href="javascript:void(0)" class="list-group-item" data-chat-user="Billy Black">
                                    <figure class="user--online">
                                        <img src="{{ asset('back/img/users/2.jpg') }}" class="rounded-circle" alt="">
                                    </figure><span><span class="name">Billy Black</span>  <span class="username">@billyblack</span> </span>
                                </a>
                                <a href="javascript:void(0)" class="list-group-item" data-chat-user="Herbert Diaz">
                                    <figure class="user--online">
                                        <img src="{{ asset('back/img/users/3.jpg') }}" class="rounded-circle" alt="">
                                    </figure><span><span class="name">Herbert Diaz</span>  <span class="username">@herbert</span> </span>
                                </a>
                                <a href="javascript:void(0)" class="list-group-item" data-chat-user="Sylvia Harvey">
                                    <figure class="user--busy">
                                        <img src="{{ asset('back/img/users/4.jpg') }}" class="rounded-circle" alt="">
                                    </figure><span><span class="name">Sylvia Harvey</span>  <span class="username">@sylvia</span> </span>
                                </a>
                                <a href="javascript:void(0)" class="list-group-item active" data-chat-user="Marsha Hoffman">
                                    <figure class="user--busy">
                                        <img src="{{ asset('back/img/users/5.jpg') }}" class="rounded-circle" alt="">
