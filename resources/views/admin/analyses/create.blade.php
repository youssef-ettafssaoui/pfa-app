...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            ...
            <div class="card">
                <div class="card-body">
                    <form class="form" action="{{ route('analyses.store') }}" method="post"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="delai"
                                        ...
                                        placeholder="Délai d'analyse" value="{{ old('delai') }}">
                                    @error('delai')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="montant"
                                    ...
                                    placeholder="Montant en DHS d'analyse" value="{{ old('montant') }}">
                                @error('montant')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="cleB"
                                        ...
                                        placeholder="Clé B d'analyse" value="{{ old('cleB') }}">
                                    @error('cleB')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
