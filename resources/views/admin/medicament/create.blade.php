...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            ...
            <div class="card">
                <div class="card-body">
                    <form class="form" action="{{ route('medicament.store') }}" method="post"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nom"
                                        ...
                                        placeholder="Nom du Médicament " value="{{ old('nom') }}">
                                    @error('nom')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="status"
                                        ...
                                        placeholder="Status du Médicament" value="Commercialisé">
                                    @error('status')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text"name="presentation"
                                    ...
                                    placeholder="Presentation du Médicament" value="{{ old('presentation') }}">
                                @error('presentation')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="prix"
                                        ...
                                        placeholder="Prix du Médicament " value="{{ old('prix') }}">
                                    @error('prix')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="indications" class="form-control @error('indications') is-invalid @enderror"
                                        placeholder="indications Médicament">{{ old('indications') }}</textarea>
                                    @error('indications')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
